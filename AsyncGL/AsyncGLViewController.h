...
#if TARGET_OS_IOS
- (instancetype)initWithMSAAEnabled:(BOOL)msaaEnabled screen:(UIScreen *)screen initialFrameRate:(NSInteger)frameRate executor:(nullable AsyncGLExecutor *)executor NS_DESIGNATED_INITIALIZER;
#else
- (instancetype)initWithMSAAEnabled:(BOOL)msaaEnabled executor:(nullable AsyncGLExecutor *)executor NS_DESIGNATED_INITIALIZER;
#endif
